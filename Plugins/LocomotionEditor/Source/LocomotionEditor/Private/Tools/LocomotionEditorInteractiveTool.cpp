...
#include "LocomotionEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "ULocomotionEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* ULocomotionEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	ULocomotionEditorInteractiveTool* NewTool = NewObject<ULocomotionEditorInteractiveTool>(SceneState.ToolManager);
...
ULocomotionEditorInteractiveToolProperties::ULocomotionEditorInteractiveToolProperties()
{
...
void ULocomotionEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void ULocomotionEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<ULocomotionEditorInteractiveToolProperties>(this, "Measurement");
...
void ULocomotionEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit ULocomotionEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void ULocomotionEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void ULocomotionEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit ULocomotionEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void ULocomotionEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void ULocomotionEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void ULocomotionEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void ULocomotionEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
