...
#include "LocomotionEditorInteractiveTool.generated.h"


/**
 * Builder for ULocomotionEditorInteractiveTool
 */
UCLASS()
class LOCOMOTIONEDITOR_API ULocomotionEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the ULocomotionEditorInteractiveTool
 */
UCLASS(Transient)
class LOCOMOTIONEDITOR_API ULocomotionEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	ULocomotionEditorInteractiveToolProperties();
...
/**
 * ULocomotionEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class LOCOMOTIONEDITOR_API ULocomotionEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<ULocomotionEditorInteractiveToolProperties> Properties;
