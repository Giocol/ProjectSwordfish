...
#include "LocomotionEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class ULocomotionEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_LocomotionEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	ULocomotionEditorEditorMode();
	virtual ~ULocomotionEditorEditorMode();
