...
#include "EntomonEditorMode.generated.h"
 ...
 */
UCLASS()
class UEntomonEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_EntomonEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UEntomonEditorMode();
	virtual ~UEntomonEditorMode();
