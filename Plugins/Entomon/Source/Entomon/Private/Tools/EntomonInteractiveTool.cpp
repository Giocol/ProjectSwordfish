...
#include "EntomonInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UEntomonInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UEntomonInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UEntomonInteractiveTool* NewTool = NewObject<UEntomonInteractiveTool>(SceneState.ToolManager);
...
UEntomonInteractiveToolProperties::UEntomonInteractiveToolProperties()
{
...
void UEntomonInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UEntomonInteractiveTool::Setup()
{
	...
	Properties = NewObject<UEntomonInteractiveToolProperties>(this, "Measurement");
...
void UEntomonInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UEntomonInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UEntomonInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UEntomonInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UEntomonInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UEntomonInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UEntomonInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UEntomonInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UEntomonInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
