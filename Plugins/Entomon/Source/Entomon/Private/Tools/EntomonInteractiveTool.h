...
#include "EntomonInteractiveTool.generated.h"


/**
 * Builder for UEntomonInteractiveTool
 */
UCLASS()
class ENTOMON_API UEntomonInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UEntomonInteractiveTool
 */
UCLASS(Transient)
class ENTOMON_API UEntomonInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEntomonInteractiveToolProperties();
...
/**
 * UEntomonInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ENTOMON_API UEntomonInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEntomonInteractiveToolProperties> Properties;
